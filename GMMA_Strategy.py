    ...
    for i in df.index:
        ...
        if (cmin > cmax):
            if (pos == 0):
                ...
                pos = 1
                print("Buying at "+str(bp) + " on "+ str(i))
        elif(cmin < cmax):
            if (pos == 1):
                pos = 0
                ...
                print("selling at "+str(sp) + " on "+str(i) + " with " + str(pc) + "%")
        ...
        if (num == df["Adj Close"].count()-1 and pos == 1):
            ...
            percentchange.append(pc)
            print("open position. if selling now at "+str(sp) + " on "+str(i) + " profit will be " + str(pc) + "%")
